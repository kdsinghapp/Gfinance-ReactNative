...
export type RegistrationStackParamList = {
  ...
  [ScreenNameEnum.OrderConfirmation]: undefined;
  [ScreenNameEnum.PricingPreview]: undefined;
  [ScreenNameEnum.ViewDetails]: { item: any };
  [ScreenNameEnum.InvoiceDetails]: { invoice?: any };
