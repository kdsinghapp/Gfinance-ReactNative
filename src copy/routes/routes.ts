...
// import PortfolioCalculatorScreen from "../screen/InvestmentPlanScreen/PortfolioCalculatorScreen";
const _routes: any = {
  REGISTRATION_ROUTE: [
    {
    ...
    // {
    //   name: ScreenNameEnum.PortfolioCalculatorScreen,
    //   Component: PortfolioCalculatorScreen,
    // },
  ],
