...
const FinancialCalculatorScreen = () => {
  ...
  const { principal: mPrincipal, monthlyPayment, monthlyRate, totalInterest, totalPaid, balancePoints, amortizationTable } = mortgageResults;
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        <View style={styles.tabContainer}>
          ...
          >
            <Text style={[styles.tabText, mode === 'investment' && styles.tabTextActive]}>{i18n.t('questions.financial.investment')}</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[styles.tabButton, mode === 'mortgage' && styles.tabButtonActive]}
            onPress={() => setMode('mortgage')}
          >
            <Text style={[styles.tabText, mode === 'mortgage' && styles.tabTextActive]}>{i18n.t('questions.financial.mortgage')}</Text>
          </TouchableOpacity>
        </View>
          ...
          {mode === 'investment' ? (
            <>
              <View style={styles.labelRow}>
                ...
                <TouchableOpacity onPress={() => showInfo('initial_investment')}>
              ...
              <View style={styles.labelRow}>
                ...
                <TouchableOpacity onPress={() => showInfo('periodic_contributions')}>
                  <Icon name="info-outline" size={18} color="#B8B8B8" />
                </TouchableOpacity>
              </View>
              <TextInput
              ...
              <View style={styles.labelRow}>
                <Text style={styles.label}>{ft.frequencyLabel || 'Frecuencia de Aportaciones'}</Text>
                <TouchableOpacity onPress={() => showInfo('contribution_frequency')}>
                  <Icon name="info-outline" size={18} color="#B8B8B8" />
                </TouchableOpacity>
              </View>
              ...
              <View style={styles.labelRow}>
                ...
                <TouchableOpacity onPress={() => showInfo('return_pct')}>
                  <Icon name="info-outline" size={18} color="#B8B8B8" />
                </TouchableOpacity>
              </View>
              <TextInput
              ...
              <View style={styles.labelRow}>
                ...
                <TouchableOpacity onPress={() => showInfo('investment_horizon')}>
                  <Icon name="info-outline" size={18} color="#B8B8B8" />
                </TouchableOpacity>
              </View>
              <TextInput
              ...
              <View style={styles.resultCard}>
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 8 }}>
                  <Text style={[styles.resultHeaderText, { marginBottom: 0 }]}>Valor futuro estimado</Text>
                  <TouchableOpacity onPress={() => showInfo('estimated_future_value')}>
              ...
              <InvestmentGraph
                ...
                onInfo={() => showInfo('calculator_growth_projection')}
              />
            </>
          ) : (
            <>
              <View style={styles.labelRow}>
                ...
                <TouchableOpacity onPress={() => showInfo('loan_amount')}>
                  <Icon name="info-outline" size={18} color="#B8B8B8" />
                </TouchableOpacity>
              </View>
              <TextInput
              ...
              <View style={styles.labelRow}>
                ...
                <TouchableOpacity onPress={() => showInfo('annual_interest_rate')}>
                  <Icon name="info-outline" size={18} color="#B8B8B8" />
                </TouchableOpacity>
              </View>
              <TextInput
              ...
              <View style={styles.labelRow}>
                ...
                <TouchableOpacity onPress={() => showInfo('loan_term_years')}>
                  <Icon name="info-outline" size={18} color="#B8B8B8" />
                </TouchableOpacity>
              </View>
              <TextInput
              ...
              <View style={styles.resultCard}>
                ...
                <View style={styles.resultValueRow}>
                  <View>
                    <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
                      <Text style={[styles.resultInfoLabel, { fontSize: 13, marginBottom: 0 }]}>Cuota Mensual (M)</Text>
                      <TouchableOpacity onPress={() => showInfo('monthly_payment_m')}>
                        <Icon name="info-outline" size={16} color="#B8B8B8" />
                      </TouchableOpacity>
                    </View>
                ...
                <View style={[styles.resultBottomRow, { marginTop: 10, flexWrap: 'wrap', gap: 16 }]}>
                  <View style={[styles.resultInfoBlock, { minWidth: '45%' }]}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4 }}>
                      <Text style={[styles.resultInfoLabel, { marginBottom: 2 }]}>{ft.capital || 'Importe'} (P)</Text>
                      <TouchableOpacity onPress={() => showInfo('capital_p')}>
                        <Icon name="info-outline" size={14} color="#B8B8B8" />
                      </TouchableOpacity>
                    </View>
                    <Text style={styles.resultInfoValue}>{formatFullCurrency(mPrincipal)}</Text>
                  </View>
                  <View style={[styles.resultInfoBlock, { minWidth: '45%' }]}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4 }}>
                      <Text style={[styles.resultInfoLabel, { marginBottom: 2 }]}>Meses (n)</Text>
                      <TouchableOpacity onPress={() => showInfo('months_n')}>
                        <Icon name="info-outline" size={14} color="#B8B8B8" />
                      </TouchableOpacity>
                    </View>
                  ...
                  <View style={[styles.resultInfoBlock, { minWidth: '45%' }]}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4 }}>
                      <Text style={[styles.resultInfoLabel, { marginBottom: 2 }]}>{ft.horizonLabel || 'Plazo'} (Años)</Text>
                      <TouchableOpacity onPress={() => showInfo('loan_term_years')}>
                        <Icon name="info-outline" size={14} color="#B8B8B8" />
                      </TouchableOpacity>
                    </View>
                ...
                <View style={styles.resultBottomRow}>
                  <View style={styles.resultInfoBlock}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4 }}>
                      <Text style={[styles.resultInfoLabel, { marginBottom: 2 }]}>{i18n.t('questions.financial.totalPaid') || 'Total a pagar'}</Text>
                      <TouchableOpacity onPress={() => showInfo('total_to_pay')}>
                        <Icon name="info-outline" size={14} color="#B8B8B8" />
                      </TouchableOpacity>
                    </View>
                  ...
                  <View style={styles.resultInfoBlock}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4 }}>
                      <Text style={[styles.resultInfoLabel, { marginBottom: 2 }]}>{i18n.t('questions.financial.totalInterest') || 'Intereses totales'}</Text>
                      <TouchableOpacity onPress={() => showInfo('total_interest')}>
                        <Icon name="info-outline" size={14} color="#B8B8B8" />
                      </TouchableOpacity>
                    </View>
              ...
              >
                <Text style={styles.generateButtonText}>{i18n.t('questions.financial.generateSim') || 'Ver el horario completo'}</Text>
              </TouchableOpacity>
            </>
          )}
        </View>
